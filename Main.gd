...
var chance_double_enemy = 0 # percentage (0 - 1)
...
func _on_spawn_timer_timeout():
	...
	for i in range(2 if randf() <= chance_double_enemy else 1):
		# choose spawn point
		while(true):
			var spawn_point = Vector2(randi_range(0, 1100), randi_range(0, 600))
